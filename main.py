...
name="xkabctt" #The bot will consider this person as its owner or creator
bot_name="Xkabctt Bot" #This will be the name of your bot, eg: "Hello I am Astro Bot"
    ...
    if request.method == "GET":
        ...
        try:
            ...
            if data["type"] == "text":
                ...
                media_url_endpoint = f'https://graph.facebook.com/v21.0/{data[data["type"]]["id"]}/'
